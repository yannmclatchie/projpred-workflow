...
regression_experiment <- function(rho, n){
  ...
  summary <- summary(ref_model_10, stats = c("elpd", "auc"))$selection
  ...
  summary200 <- summary(ref_model_200, stats = c("elpd", "auc"))$selection
  ...
  summary50 <- summary(ref_model_50, stats = c("elpd", "auc"))$selection
...
# write the table
csv_name <- paste0("./data/pred_draws/classification.csv")
